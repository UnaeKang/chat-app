...
public class ListenerConfig {
    ...
    public Map<String, Object> consumerConfigurations() {
        ...
        configurations.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, KafkaConstans.KAFKA_BROKER);
        configurations.put(ConsumerConfig.GROUP_ID_CONFIG, KafkaConstans.GROUP_ID);
